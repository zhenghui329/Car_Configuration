...
public abstract class ProxyAutomobile {
    ...
    public String getModelList(){
        return autos.getModelList();
    }

    public Automobile findModel(int select){
        return autos.getModel(select);
    }

    public Automobile findModelByName(String modelName){
        return autos.findByModelName(modelName);
    }
