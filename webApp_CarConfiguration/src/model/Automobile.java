...
//    }
	...
	/**************************
	 *
	 * Index Validation These validation method should be called before passing a
	 * number to the method that uses index as a parameter
	 *
	 ************************/
	/*
	 * public boolean isValidIndex(int optionSetIndex){ return optionSetIndex >= 0
	 * && optionSetIndex < optSet.size(); } public boolean isValidPos(int index, int
	 * optionPos){ return optionPos >= 0 && optionPos < getOptionList(index).size();
	 * }
	 */
